    ...
    <section className="relative bg-linear-to-b from-black via-gray-900 to-black py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          {projectCategories.map((category, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative bg-gray-900/40 backdrop-blur-sm border border-gray-800/50 rounded-2xl p-8 hover:border-blue-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/10 overflow-hidden"
              >
                ...
                <div className="relative mb-6">
                  ...
                  <div className="h-1 w-full bg-linear-to-r from-blue-500/50 to-transparent rounded-full"></div>
                </div>
                ...
                <div className="relative space-y-3">
                  {category.clients.map((client, clientIndex) => (
                    <div
                      key={clientIndex}
                      className="flex items-center gap-3 text-gray-400 hover:text-blue-300 transition-colors duration-300 group/item"
                    >
                      <ChevronRight className="w-4 h-4 text-blue-500/50 group-hover/item:text-blue-400 group-hover/item:translate-x-1 transition-all duration-300" />
                ...
                {/* Client Count Badge */}
                <div className="relative mt-6 pt-6 border-t border-gray-800/50">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-gray-900/30 backdrop-blur-sm border border-gray-800/50 rounded-xl p-6 text-center hover:border-blue-500/30 transition-all duration-300">
            <div className="text-4xl font-bold text-blue-400 mb-2">24+</div>
            <div className="text-gray-400 text-sm">Total Projects</div>
          </div>
          <div className="bg-gray-900/30 backdrop-blur-sm border border-gray-800/50 rounded-xl p-6 text-center hover:border-blue-500/30 transition-all duration-300">
            <div className="text-4xl font-bold text-blue-400 mb-2">3</div>
            <div className="text-gray-400 text-sm">Business Verticals</div>
          </div>
          <div className="bg-gray-900/30 backdrop-blur-sm border border-gray-800/50 rounded-xl p-6 text-center hover:border-blue-500/30 transition-all duration-300">
