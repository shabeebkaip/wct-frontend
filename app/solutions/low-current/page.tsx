          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 border border-blue-300 dark:bg-blue-500/10 dark:border-blue-500/30 mb-6">
                ...
                <span className="text-sm font-medium text-blue-700 dark:text-blue-400">Low-Current & ICT Solutions</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 border border-blue-300 dark:bg-blue-500/10 dark:border-blue-500/30 mb-6">
              ...
              <span className="text-sm font-medium text-blue-700 dark:text-blue-400">Technologies</span>
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-gray-100 mb-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {technologies.map((tech, index) => (
              ...
              >
                ...
                <div className="relative">
                  <h3 className="text-lg font-bold text-slate-900 dark:text-gray-100 mb-3">{tech.category}</h3>
                  <div className="flex flex-wrap gap-2">
                    {tech.items.map((item, idx) => (
                      <span
                        key={idx}
                        className="px-3 py-1 rounded-lg bg-blue-100 border border-blue-300 text-xs text-blue-700 dark:bg-blue-500/10 dark:border-blue-500/30 dark:text-blue-400"
                      >
                        {item}
                      </span>
                    ))}
